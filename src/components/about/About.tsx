      ...
      return(
        <div className="alert">
          <Heading as="h3" size={getAlertSize()}>
            💻{"   "}<a href="sohailahmedlaghari21@gmail.com" className="contact-link">Hire Me!</a>
        ...
        <div className="about-wrapper">
          <div className="about-text">
            <div className="about-title">
              ...
              <Heading as='h1' fontSize={getFontSize()} size='4xl'>
                {text[language].aboutIam} <span className="name"> Sohail Ahmed</span>
              </Heading>
            </div>
            ...
            <div className="icons">
              <a href="https://github.com/12SohailBlockchain" target="_blank" rel="noreferrer">
              ...
              <a href="sohailahmedlaghari21@gmail.com" target="_blank" rel="noreferrer">
